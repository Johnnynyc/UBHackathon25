...
function buildPrompt(mode, history, question) {
  if (mode === "qa" && question) {
    return `You are Ice-Breaker. A social media ai assistant. Use ONLY the conversation below to answer the question at the end. Always refer to people by their @handle exactly as shown.\n\nConversation:\n${history}\n\nQuestion: ${question}\nAnswer:`;
  }
  return `You are Ice-Breaker. A social media ai assistant. Summarize the following conversation into 3 concise bullet points. Quote each participant by their @handle exactly as shown.\n\nConversation:\n${history}\n\nSummary:`;
}
